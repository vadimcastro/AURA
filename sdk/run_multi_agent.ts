...
async function main() {
  ...
  // Split 100 dUSDC per agent, 0.2 SUI for gas
  const agent1 = await setupAgent(ownerKeypair, "Conservative Yield Hunter", dusdcCoinId, 100_000_000, 200_000_000);
  const agent2 = await setupAgent(ownerKeypair, "Aggressive Vol Trader", dusdcCoinId, 100_000_000, 200_000_000);
  const agent3 = await setupAgent(ownerKeypair, "Delta-Neutral Bot", dusdcCoinId, 100_000_000, 200_000_000);
