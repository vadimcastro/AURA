...
async function main() {
  ...
  const agent1 = await setupAgent(ownerKeypair, "Conservative Yield Hunter", dusdcCoinId, 25_000_000, 20_000_000);
  const agent2 = await setupAgent(ownerKeypair, "Aggressive Vol Trader", dusdcCoinId, 25_000_000, 20_000_000);
  const agent3 = await setupAgent(ownerKeypair, "Delta-Neutral Bot", dusdcCoinId, 25_000_000, 20_000_000);
